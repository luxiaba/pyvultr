...
class TestBareMetal(BaseTestV2):
    def test_list(self):
        ...
        with self._get("response/bare_metal_list") as mock:
            ...
            excepted_result = BareMetalItem.from_dict(_excepted_result)

            _real_result = self.api_v2.bare_metal.list(capacity=1)
            real_result: BareMetalItem = _real_result.first()
    ...
    def test_get(self):
        """Test get bare metal."""
        with self._get("response/bare_metal", expected_returned=BareMetalItem) as mock:
            excepted_result = mock.python_body

            real_result: BareMetalItem = self.api_v2.bare_metal.get(excepted_result.id)
    ...
    def test_update(self):
        ...
        with self._patch("response/bare_metal", expected_returned=BareMetalItem) as mock:
            excepted_result = mock.python_body

            real_result: BareMetalItem = self.api_v2.bare_metal.update(excepted_result.id, label="Example Bare Metal")
    ...
    def test_list_ipv4s(self):
        ...
        with self._get("response/bare_metal_ipv4s") as mock:
            ...
            excepted_result = BareMetalIPV4Item.from_dict(_excepted_result)
    ...
    def test_list_ipv6s(self):
        ...
        with self._get("response/bare_metal_ipv6s") as mock:
            ...
            excepted_result = BareMetalIPV6Item.from_dict(_excepted_result)
    ...
    def test_get_bandwidth(self):
        ...
        with self._get("response/bare_metal_bandwidth") as mock:
            ...
            excepted_result = {
                _date: BareMetalBandwidthItem.from_dict(item) for _date, item in _excepted_result.items()
            }

            bare_metal_id = str(uuid.uuid4())
            real_result: Dict[str, BareMetalBandwidthItem] = self.api_v2.bare_metal.get_bandwidth(bare_metal_id)
    ...
    def test_reinstall(self):
        ...
        with self._post("response/bare_metal", status_code=202, expected_returned=BareMetalItem) as mock:
            excepted_result: BareMetalItem = mock.python_body

            real_result: BareMetalItem = self.api_v2.bare_metal.reinstall(excepted_result.id)
    ...
    def test_get_user_data(self):
        ...
        with self._get("response/bare_metal_user_data", expected_returned=BareMetalUserData) as mock:
            excepted_result: BareMetalUserData = mock.python_body

            bare_metal_id = str(uuid.uuid4())
            real_result: BareMetalUserData = self.api_v2.bare_metal.get_user_data(bare_metal_id)
